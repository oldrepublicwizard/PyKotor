...
function Generate-CiWorkflow {
    ...
    if ($PyKotorDeps -contains "pykotor") {
        $installCommands += 'pip install "pykotor @ git+https://github.com/oldrepublicwizard/PyKotor-lib.git"'
    }
    if ($PyKotorDeps -contains "pykotorgl") {
        $installCommands += 'pip install "pykotorgl @ git+https://github.com/oldrepublicwizard/PyKotorGL.git"'
    }
