...
| Forward Commits (post-#306) | https://github.com/OpenKotOR/PyKotor/actions/runs/26547475742 |  ⏳ queued — merge on `7d85438`|
...
**Last CI check (plan 115):** 2026-05-27 — verify [26372746392](https://github.com/OpenKotOR/PyKotor/actions/runs/26372746392) success on `8916e2f`; FC [26547475742](https://github.com/OpenKotOR/PyKotor/actions/runs/26547475742) queued on `7d85438`.

**Plans:** 019–117 document the closeout track; authoritative learning in `docs/solutions/testing/verify-pypi-regression-closeout.md`.
