...
class Ui_LYTEditor(object):
    def setupUi(self, LYTEditor):
        ...
        self.viewStack = QtWidgets.QStackedWidget(self.leftWidget)
        self.viewStack.setObjectName("viewStack")
        self.topDownPage = QtWidgets.QWidget()
        self.topDownPage.setObjectName("topDownPage")
        self.verticalLayout_7 = QtWidgets.QVBoxLayout(self.topDownPage)
        ...
        self.threeDPage = QtWidgets.QWidget()
        self.threeDPage.setObjectName("threeDPage")
        self.verticalLayout_8 = QtWidgets.QVBoxLayout(self.threeDPage)
        self.verticalLayout_8.setObjectName("verticalLayout_8")
        self.openGLWidget = QtWidgets.QOpenGLWidget(self.threeDPage)
        self.openGLWidget.setObjectName("openGLWidget")
        self.verticalLayout_8.addWidget(self.openGLWidget)
        self.viewStack.addWidget(self.threeDPage)
        self.verticalLayout.addWidget(self.viewStack)
        self.zoomSlider = QtWidgets.QSlider(self.leftWidget)
        ...
        self.texturesGroupBox = QtWidgets.QGroupBox(self.rightWidget)
        ...
        self.textureBrowser = QtWidgets.QListWidget(self.texturesGroupBox)
        self.textureBrowser.setObjectName("textureBrowser")
        self.verticalLayout_9.addWidget(self.textureBrowser)
        self.importTextureButton = QtWidgets.QPushButton(self.texturesGroupBox)
        ...
        self.roomTemplatesGroupBox = QtWidgets.QGroupBox(self.rightWidget)
        ...
        self.roomTemplateList = QtWidgets.QListWidget(self.roomTemplatesGroupBox)
        ...
        self.importModelButton = QtWidgets.QPushButton(self.rightWidget)
        self.importModelButton.setObjectName("importModelButton")
        self.verticalLayout_2.addWidget(self.importModelButton)
        self.generateWalkmeshButton = QtWidgets.QPushButton(self.rightWidget)
