...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.detectDcSpin.setMinimum(0)
        self.detectDcSpin.setMaximum(255)
        ...
        self.disarmDcSpin.setMinimum(0)
        self.disarmDcSpin.setMaximum(255)
        ...
        self.formLayout_5.setWidget(4, QtWidgets.QFormLayout.FieldRole, self.onHeartbeatSelect)
        ...
        self.formLayout_5.setWidget(3, QtWidgets.QFormLayout.FieldRole, self.onExitSelect)
        self.onEnterSelect = FilterComboBox(self.tab_4)
        self.onEnterSelect.setObjectName("onEnterSelect")
        self.formLayout_5.setWidget(2, QtWidgets.QFormLayout.FieldRole, self.onEnterSelect)
        self.onUserDefinedSelect = FilterComboBox(self.tab_4)
        self.onUserDefinedSelect.setObjectName("onUserDefinedSelect")
        self.formLayout_5.setWidget(6, QtWidgets.QFormLayout.FieldRole, self.onUserDefinedSelect)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.nameEdit.setToolTip(_translate("MainWindow", "Name (GFF: LocalizedName). CExoLocString. Localized trigger name. Not used by the game engine. Default when missing: empty. Modders: toolset/display only."))
        self.label_14.setText(_translate("MainWindow", "Tag:"))
        self.tagEdit.setToolTip(_translate("MainWindow", "Tag (GFF: Tag). CExoString. Trigger tag for scripts and linking. Default when missing: \"\". Modders: keep unique in area for script targeting."))
        self.tagGenerateButton.setToolTip(_translate("MainWindow", "Copy the Template ResRef into the Tag field so they stay in sync. Use when you need to reference this trigger by tag in scripts; keep Tag unique per area. Scripts use GetObjectByTag to find triggers."))
        self.tagGenerateButton.setText(_translate("MainWindow", "-"))
        self.label_38.setText(_translate("MainWindow", "ResRef:"))
        self.resrefEdit.setToolTip(_translate("MainWindow", "ResRef (GFF: TemplateResRef). CResRef. Trigger template resource reference. Default when missing: blank. Modders: max 16 chars; .utt extension implied."))
        self.resrefGenerateButton.setToolTip(_translate("MainWindow", "Copy the Tag into the Template ResRef field (max 16 characters). ResRef should match the UTT filename so the game finds the template when loading triggers from the GIT."))
        self.resrefGenerateButton.setText(_translate("MainWindow", "-"))
        self.label_2.setText(_translate("MainWindow", "Type:"))
        self.typeSelect.setToolTip(_translate("MainWindow", "Type (GFF: Type). INT32. Trigger type: 0 Generic, 1 Transition, 2 Trap. Default when missing: 0. Modders: affects cursor and behavior."))
        ...
        self.cursorSelect.setToolTip(_translate("MainWindow", "Cursor (GFF: Cursor). BYTE. Cursor type when hovering trigger. Default when missing: 0. Modders: from cursors.2da."))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab), _translate("MainWindow", "Basic"))
        self.autoRemoveKeyCheckbox.setToolTip(_translate("MainWindow", "Auto Remove Key (GFF: AutoRemoveKey). BYTE. Key removed from inventory after use. Default when missing: 0. Modders: 0 or 1."))
        ...
        self.keyEdit.setToolTip(_translate("MainWindow", "Key Name (GFF: KeyName). CExoString. Tag of key item required to open/lock. Default when missing: \"\". Modders: leave blank if no key required."))
        self.label.setText(_translate("MainWindow", "Faction:"))
        self.factionSelect.setToolTip(_translate("MainWindow", "Faction (GFF: Faction). DWORD. Faction identifier for reaction/combat. Default when missing: 0. Modders: from faction.2da."))
        self.highlightHeightSpin.setToolTip(_translate("MainWindow", "Highlight Height (GFF: HighlightHeight). FLOAT. Height of trigger highlight area. Default when missing: 0.0. Modders: affects visible trigger bounds."))
        ...
        self.isTrapCheckbox.setToolTip(_translate("MainWindow", "Is a trap (GFF: TrapFlag). BYTE. Trigger has trap behavior. Default when missing: 0. Modders: enable to use trap type/DC fields."))
        self.isTrapCheckbox.setText(_translate("MainWindow", "Is a trap"))
        self.activateOnceCheckbox.setToolTip(_translate("MainWindow", "Activate Once (GFF: TrapOneShot). BYTE. Trap fires only once. Default when missing: 0. Modders: 0 = repeatable, 1 = one shot."))
        ...
        self.trapSelect.setToolTip(_translate("MainWindow", "Trap Type (GFF: TrapType). BYTE. Trap type from traps.2da. Default when missing: 0. Modders: used when Is a trap is set."))
        self.detectableCheckbox.setToolTip(_translate("MainWindow", "Detectable (GFF: TrapDetectable). BYTE. Trap can be detected by skills. Default when missing: 0. Modders: use with Detect DC."))
        self.detectableCheckbox.setText(_translate("MainWindow", "Detectable"))
        self.label_4.setText(_translate("MainWindow", "Detect DC:"))
        self.detectDcSpin.setToolTip(_translate("MainWindow", "Detect DC (GFF: TrapDetectDC). BYTE 0–255. Difficulty class for Awareness to detect the trap. Note: K1 LoadTrigger does not read this—trigger DC comes from traps.2da DetectDCMod. PyKotor stores it for GFF compatibility (doors/placeables use it). Modders: set 0–255; used when Detectable is checked. Doors and placeables read this field; triggers use traps.2da."))
        self.disarmableCheckbox.setToolTip(_translate("MainWindow", "Disarmable (GFF: TrapDisarmable). BYTE. Trap can be disarmed. Default when missing: 0. Modders: use with Disarm DC."))
        self.disarmableCheckbox.setText(_translate("MainWindow", "Disarmable"))
        self.label_5.setText(_translate("MainWindow", "Disarm DC:"))
        self.disarmDcSpin.setToolTip(_translate("MainWindow", "Disarm DC (GFF: DisarmDC). BYTE 0–255. Difficulty class for Security to disarm the trap. Note: K1 LoadTrigger does not read this—trigger DC comes from traps.2da DisarmDCMod. PyKotor stores it for GFF compatibility (doors/placeables use it). Modders: set 0–255; used when Disarmable is checked. Doors and placeables read this field; triggers use traps.2da."))
        ...
        self.onHeartbeatSelect.setToolTip(_translate("MainWindow", "OnHeartbeat (GFF: ScriptHeartbeat). CResRef. Script run on heartbeat while in trigger. Default when missing: blank. Modders: .ncs script ResRef."))
        ...
        self.onExitSelect.setToolTip(_translate("MainWindow", "OnExit (GFF: ScriptOnExit). CResRef. Script run when creature exits trigger. Default when missing: blank. Modders: .ncs script ResRef."))
        self.onEnterSelect.setToolTip(_translate("MainWindow", "OnEnter (GFF: ScriptOnEnter). CResRef. Script run when creature enters trigger. Default when missing: blank. Modders: .ncs script ResRef."))
        self.onUserDefinedSelect.setToolTip(_translate("MainWindow", "OnUserDefined (GFF: ScriptUserDefine). CResRef. Script run on user-defined event. Default when missing: blank. Modders: .ncs script ResRef."))
        ...
        self.onTrapTriggeredEdit.setToolTip(_translate("MainWindow", "OnTrapTriggered (GFF: OnTrapTriggered). CResRef. Script run when trap fires. Default when missing: blank. Modders: .ncs script ResRef."))
        self.onDisarmEdit.setToolTip(_translate("MainWindow", "OnDisarm (GFF: OnDisarm). CResRef. Script run when trap is disarmed. Default when missing: blank. Modders: .ncs script ResRef."))
        self.onClickEdit.setToolTip(_translate("MainWindow", "OnClick (GFF: OnClick). CResRef. Script run when trigger is clicked. Default when missing: blank. Modders: .ncs script ResRef."))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab_4), _translate("MainWindow", "Scripts"))
        self.commentsEdit.setToolTip(_translate("MainWindow", "Comments (GFF: Comment). CExoString. Developer comment; not used by the game engine. Default when missing: \"\". Modders: toolset only."))
