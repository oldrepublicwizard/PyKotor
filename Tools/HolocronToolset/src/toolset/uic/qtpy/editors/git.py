...
"")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.filterEdit.setToolTip(_translate("MainWindow", "Filter the instance list by tag or resref. Type part of a creature, door, placeable, trigger, waypoint, or sound tag to show only matching entries. Max 16 characters. Does not change the GIT file—only filters what is shown in the list. Leave empty to show all instances."))
        self.filterEdit.setPlaceholderText(_translate("MainWindow", "filter..."))
        self.listWidget.setToolTip(_translate("MainWindow", "Instance list. Shows all creatures, doors, placeables, triggers, waypoints, and sounds in this area (GIT). Click an entry to select it in the 3D view and edit its position, rotation, or template. Use the filter box above to narrow the list by tag or resref. Right-click for context menu (add, remove, duplicate)."))
        self.lockInstancesCheck.setToolTip(_translate("MainWindow", "Lock instances. When checked, prevents moving, rotating, or deleting instances in the 3D view. Use when you want to select or inspect without accidentally editing. Does not modify the GIT file until you change an instance and save."))
        self.label.setText(_translate("MainWindow", "|"))
        self.viewCreatureCheck.setToolTip(_translate("MainWindow", "Show or hide creature instances in the 3D view. Creatures (UTC) are NPCs, enemies, and party members placed in the area. Uncheck to hide them while editing other object types. Does not remove them from the GIT."))
        self.viewDoorCheck.setToolTip(_translate("MainWindow", "Show or hide door instances (UTD) in the 3D view. Doors link areas or open/close; they use a door template and position. Uncheck to hide them while editing other objects. Does not remove them from the GIT."))
        self.viewPlaceableCheck.setToolTip(_translate("MainWindow", "Show or hide placeable instances (UTP) in the 3D view. Placeables are containers, chairs, crates, and other interactive objects. Uncheck to hide them. Does not remove them from the GIT."))
        self.viewStoreCheck.setToolTip(_translate("MainWindow", "Show or hide merchant/store placeables in the 3D view. Merchants are placeables with store data; toggling this only affects visibility, not the GIT."))
        self.viewSoundCheck.setToolTip(_translate("MainWindow", "Show or hide sound object instances (UTS) in the 3D view. Sound objects play ambient audio; they have a position when positional. Uncheck to hide them. Does not remove them from the GIT."))
        self.viewWaypointCheck.setToolTip(_translate("MainWindow", "Show or hide waypoint instances (UTW) in the 3D view. Waypoints are invisible markers used for scripting (e.g. MoveToPoint). Uncheck to hide them. Does not remove them from the GIT."))
        self.viewCameraCheck.setToolTip(_translate("MainWindow", "Show or hide camera instances in the 3D view. Cameras define camera positions/cuts for cutscenes. Uncheck to hide them. Does not remove them from the GIT."))
        self.viewEncounterCheck.setToolTip(_translate("MainWindow", "Show or hide encounter instances (UTE) in the 3D view. Encounters spawn creatures when the player enters the region. Uncheck to hide them. Does not remove them from the GIT."))
        self.viewTriggerCheck.setToolTip(_translate("MainWindow", "Show or hide trigger instances (UTT) in the 3D view. Triggers detect when the player enters a region and run scripts. Uncheck to hide them. Does not remove them from the GIT."))
