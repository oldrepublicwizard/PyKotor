...
class Ui_MainWindow(object):
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.nameEdit.setToolTip(_translate("MainWindow", "Name (GFF: LocalizedName). CExoLocString. Display name on area map and travel menu. Default when missing: empty. Modders: descriptive name (e.g. \"Dantooine - Jedi Enclave\"); scripts target by Tag, not name."))
        self.label_14.setText(_translate("MainWindow", "Tag:"))
        self.tagEdit.setToolTip(_translate("MainWindow", "Tag (GFF: Tag). CExoString. Unique waypoint identifier for scripts and transitions. Default when missing: \"\". Modders: keep unique per module; GetObjectByTag and doors/triggers use this."))
        self.tagGenerateButton.setToolTip(_translate("MainWindow", "Generate Tag from ResRef. Copies Template ResRef into Tag so they stay in sync for script targeting."))
        self.tagGenerateButton.setText(_translate("MainWindow", "-"))
        self.label_38.setText(_translate("MainWindow", "ResRef:"))
        self.resrefEdit.setToolTip(_translate("MainWindow", "ResRef (GFF: TemplateResRef). CResRef. Waypoint template resource reference; .utw implied. Default when missing: blank. Modders: max 16 chars; must match .utw filename or area load fails."))
        self.resrefGenerateButton.setToolTip(_translate("MainWindow", "Generate ResRef from Tag. Copies Tag into Template ResRef (max 16 chars); ResRef must match .utw filename."))
        ...
        self.isNoteCheckbox.setToolTip(_translate("MainWindow", "Is a Map Note (GFF: HasMapNote). BYTE. Waypoint shows custom text on area map. Default when missing: 0. Modders: set 1 to enable; MapNote and MapNoteEnabled only read when this is set."))
        self.isNoteCheckbox.setText(_translate("MainWindow", "Is a Map Note"))
        self.noteEnabledCheckbox.setToolTip(_translate("MainWindow", "Map Note is Enabled (GFF: MapNoteEnabled). BYTE. Map note pin initially visible. Default when missing: 0. Modders: only when Is a Map Note is set; 1 = visible, 0 = hidden (scripts can toggle)."))
        ...
        self.noteEdit.setToolTip(_translate("MainWindow", "Map Note (GFF: MapNote). CExoLocString. Text shown on area map. Default when missing: empty. Modders: only read when Is a Map Note is set; use for quest hints or location labels."))
        self.noteChangeButton.setToolTip(_translate("MainWindow", "Edit Map Note. Opens localized string editor for Map Note (GFF: MapNote); supports multiple languages."))
