...
from qtpy.QtCore import QPointF, Qt, QPoint
from qtpy.QtWidgets import QListWidgetItem, QPlainTextDocumentLayout, QMessageBox
...
def test_nss_editor_document_layout(qtbot: QtBot, installation: HTInstallation):
...
def test_nss_editor_new_file_creation(qtbot: QtBot, installation: HTInstallation):
...
def test_nss_editor_code_editing_basic(qtbot: QtBot, installation: HTInstallation):
...
def test_nss_editor_load_nss_file(qtbot: QtBot, installation: HTInstallation, tmp_path: Path):
...
def test_nss_editor_save_load_roundtrip(qtbot: QtBot, installation: HTInstallation, tmp_path: Path):
...
def test_nss_editor_bookmark_add_and_navigate(
    qtbot: QtBot,
    installation: HTInstallation,
    complex_nss_script: str,
):
...
def test_nss_editor_bookmark_persistence(qtbot: QtBot, installation: HTInstallation):
...
def test_nss_editor_snippet_add_and_insert(qtbot: QtBot, installation: HTInstallation):
...
def test_nss_editor_snippet_filter(qtbot: QtBot, installation: HTInstallation):
...
def test_nss_editor_snippet_persistence(qtbot: QtBot, installation: HTInstallation):
...
def test_nss_editor_syntax_highlighting_setup(qtbot: QtBot, installation: HTInstallation):
...
def test_nss_editor_syntax_highlighting_game_switch(qtbot: QtBot, installation: HTInstallation):
...
def test_nss_editor_autocompletion_setup(qtbot: QtBot, installation: HTInstallation):
...
def test_nss_editor_functions_list_populated(qtbot: QtBot, installation: HTInstallation):
...
def test_nss_editor_constants_list_populated(qtbot: QtBot, installation: HTInstallation):
...
def test_nss_editor_insert_function(qtbot: QtBot, installation: HTInstallation):
...
def test_nss_editor_insert_constant(qtbot: QtBot, installation: HTInstallation):
...
def test_nss_editor_game_selector_switch(qtbot: QtBot, installation: HTInstallation):
...
def test_nss_editor_game_selector_ui(qtbot: QtBot, installation: HTInstallation):
...
def test_nss_editor_find_replace_setup(qtbot: QtBot, installation: HTInstallation):
...
def test_nss_editor_error_diagnostics_setup(qtbot: QtBot, installation: HTInstallation):
...
def test_nss_editor_error_reporting(qtbot: QtBot, installation: HTInstallation):
...
def test_nss_editor_clear_errors(qtbot: QtBot, installation: HTInstallation):
...
def test_nss_editor_compilation_ui_setup(qtbot: QtBot, installation: HTInstallation):
...
def test_nss_editor_file_explorer_setup(qtbot: QtBot, installation: HTInstallation):
...
def test_nss_editor_terminal_setup(qtbot: QtBot, installation: HTInstallation):
...
def test_nss_editor_context_menu_exists(qtbot: QtBot, installation: HTInstallation):
...
def test_nss_editor_scrollbar_filter_setup(qtbot: QtBot, installation: HTInstallation):
...
def test_nss_editor_output_panel_exists(qtbot: QtBot, installation: HTInstallation):
...
def test_nss_editor_log_to_output(qtbot: QtBot, installation: HTInstallation):
...
def test_nss_editor_status_bar_setup(qtbot: QtBot, installation: HTInstallation):
...
def test_nss_editor_panel_toggle_actions(qtbot: QtBot, installation: HTInstallation):
...
def test_nss_editor_full_workflow(qtbot: QtBot, installation: HTInstallation):
...
def test_nss_editor_multiple_modifications_roundtrip(qtbot: QtBot, installation: HTInstallation):
...
def test_nss_editor_all_widgets_exist(qtbot: QtBot, installation: HTInstallation):
...
def test_nss_editor_menu_bar_exists(qtbot: QtBot, installation: HTInstallation):
...
def test_nss_editor_goto_line(qtbot: QtBot, installation: HTInstallation, complex_nss_script: str):
...
def test_nss_editor_breadcrumbs_setup(qtbot: QtBot, installation: HTInstallation):
...
def test_nss_editor_select_next_occurrence(qtbot: QtBot, installation: HTInstallation):
...
def test_nss_editor_select_all_occurrences(qtbot: QtBot, installation: HTInstallation):
...
def test_nss_editor_select_line(qtbot: QtBot, installation: HTInstallation):
...
def test_nss_editor_column_selection_mode(qtbot: QtBot, installation: HTInstallation):
...
xyz uvw"""
    ...
    press_event = QMouseEvent(
        ...
        QPointF(press_pos.x(), press_pos.y()),
...
def test_nss_editor_word_selection_shortcuts(qtbot: QtBot, installation: HTInstallation):
...
def test_nss_editor_duplicate_line_shortcut(qtbot: QtBot, installation: HTInstallation):
...
def test_nss_editor_command_palette_actions(qtbot: QtBot, installation: HTInstallation):
...
def test_nss_editor_bracket_matching(qtbot: QtBot, installation: HTInstallation):
...
def test_nss_editor_fold_empty_block(qtbot: QtBot, installation: HTInstallation):
...
def test_nss_editor_fold_nested_blocks(qtbot: QtBot, installation: HTInstallation):
...
def test_nss_editor_breadcrumbs_no_context(qtbot: QtBot, installation: HTInstallation):
...
def test_nss_editor_word_selection_no_match(qtbot: QtBot, installation: HTInstallation):
...
def test_nss_editor_fold_malformed_code(qtbot: QtBot, installation: HTInstallation):
...
def test_nss_editor_breadcrumbs_multiple_functions(qtbot: QtBot, installation: HTInstallation):
...
def test_nss_editor_foldable_regions_large_file(qtbot: QtBot, installation: HTInstallation):
