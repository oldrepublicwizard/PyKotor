...
This layout mirrors the Holocron Toolset indoor-kit data model and loader package structure ([`toolset/data/indoorkit/`](https://github.com/OldRepublicDevs/PyKotor/tree/master/Tools/HolocronToolset/src/toolset/data/indoorkit)).
...
All of these JSON fields are loaded and validated directly by the indoor-kit loader implementation ([`indoorkit_loader.py` L23-L260](https://github.com/OldRepublicDevs/PyKotor/blob/a8daa4091b067e8424ae537793224e6b178ee9d8/Tools/HolocronToolset/src/toolset/data/indoorkit/indoorkit_loader.py#L23-L260)).
...
This re-centering behavior is implemented in the kit extraction flow that translates component walkmeshes and emits normalized component outputs ([`kit.py` L1538-L1588](https://github.com/OldRepublicDevs/PyKotor/blob/a8daa4091b067e8424ae537793224e6b178ee9d8/Libraries/PyKotor/src/pykotor/tools/kit.py#L1538-L1588)).
...
This edge-to-hook extraction and transition mapping logic is implemented in the same kit extraction path ([`kit.py` L1467-L1535](https://github.com/OldRepublicDevs/PyKotor/blob/a8daa4091b067e8424ae537793224e6b178ee9d8/Libraries/PyKotor/src/pykotor/tools/kit.py#L1467-L1535)).
...
Connection evaluation behavior is defined by the indoor-kit base model's hook compatibility logic ([`indoorkit_base.py` L88-L106](https://github.com/OldRepublicDevs/PyKotor/blob/a8daa4091b067e8424ae537793224e6b178ee9d8/Tools/HolocronToolset/src/toolset/data/indoorkit/indoorkit_base.py#L88-L106)).
...
This conversion path is implemented directly in the kit extraction texture pipeline ([`kit.py` L926-L948](https://github.com/OldRepublicDevs/PyKotor/blob/a8daa4091b067e8424ae537793224e6b178ee9d8/Libraries/PyKotor/src/pykotor/tools/kit.py#L926-L948)).
...
The exact priority ordering used here comes from the resource-location ranking logic in the kit tooling ([`kit.py` L74-L120](https://github.com/OldRepublicDevs/PyKotor/blob/a8daa4091b067e8424ae537793224e6b178ee9d8/Libraries/PyKotor/src/pykotor/tools/kit.py#L74-L120)).
...
This batching behavior is implemented in the texture/lightmap lookup and extraction routines used by kit generation ([`kit.py` L814-L964](https://github.com/OldRepublicDevs/PyKotor/blob/a8daa4091b067e8424ae537793224e6b178ee9d8/Libraries/PyKotor/src/pykotor/tools/kit.py#L814-L964)).
...
The embedded-first then standalone fallback flow is implemented in the same extraction block that writes texture assets for kits ([`kit.py` L849-L1020](https://github.com/OldRepublicDevs/PyKotor/blob/a8daa4091b067e8424ae537793224e6b178ee9d8/Libraries/PyKotor/src/pykotor/tools/kit.py#L849-L1020)).
...
Always-folder resource injection is handled by the indoor map generation path that calls `add_static_resources()` during room processing ([`indoormap.py` L236-L256](https://github.com/OldRepublicDevs/PyKotor/blob/a8daa4091b067e8424ae537793224e6b178ee9d8/Tools/HolocronToolset/src/toolset/data/indoormap.py#L236-L256)).
...
This door extraction path is implemented in the kit builder's door processing routine ([`kit.py` L1253-L1304](https://github.com/OldRepublicDevs/PyKotor/blob/a8daa4091b067e8424ae537793224e6b178ee9d8/Libraries/PyKotor/src/pykotor/tools/kit.py#L1253-L1304)).
...
This DWK lookup and extraction sequence is implemented in the door walkmesh path in the kit toolchain ([`kit.py` L1090-L1174](https://github.com/OldRepublicDevs/PyKotor/blob/a8daa4091b067e8424ae537793224e6b178ee9d8/Libraries/PyKotor/src/pykotor/tools/kit.py#L1090-L1174)).
...
This placeable extraction and PWK write flow is implemented in the corresponding kit extraction stage ([`kit.py` L1176-L1251](https://github.com/OldRepublicDevs/PyKotor/blob/a8daa4091b067e8424ae537793224e6b178ee9d8/Libraries/PyKotor/src/pykotor/tools/kit.py#L1176-L1251)).
...
These PWK resolution rules are implemented in the same placeable walkmesh extraction routine ([`kit.py` L1176-L1251](https://github.com/OldRepublicDevs/PyKotor/blob/a8daa4091b067e8424ae537793224e6b178ee9d8/Libraries/PyKotor/src/pykotor/tools/kit.py#L1176-L1251)).
...
This skybox/component distinction is implemented by the model classification logic in the extraction pipeline ([`kit.py` L740-L744](https://github.com/OldRepublicDevs/PyKotor/blob/a8daa4091b067e8424ae537793224e6b178ee9d8/Libraries/PyKotor/src/pykotor/tools/kit.py#L740-L744)).
...
The doorway filename parsing and loader conventions are implemented in the indoor-kit loader's doorway section ([`indoorkit_loader.py` L127-L150](https://github.com/OldRepublicDevs/PyKotor/blob/a8daa4091b067e8424ae537793224e6b178ee9d8/Tools/HolocronToolset/src/toolset/data/indoorkit/indoorkit_loader.py#L127-L150)).
...
This extra-model export stage is handled by the kit extraction logic for non-component, non-skybox models ([`kit.py` L1311-L1324](https://github.com/OldRepublicDevs/PyKotor/blob/a8daa4091b067e8424ae537793224e6b178ee9d8/Libraries/PyKotor/src/pykotor/tools/kit.py#L1311-L1324)).
...
This archive handling and precedence logic is implemented in the `extract_kit()` archive resolution flow ([`kit.py` L291-L550](https://github.com/OldRepublicDevs/PyKotor/blob/a8daa4091b067e8424ae537793224e6b178ee9d8/Libraries/PyKotor/src/pykotor/tools/kit.py#L291-L550)).
...
This component-identification sequence is implemented in the model classification and mapping pass in the kit extraction code ([`kit.py` L600-L767](https://github.com/OldRepublicDevs/PyKotor/blob/a8daa4091b067e8424ae537793224e6b178ee9d8/Libraries/PyKotor/src/pykotor/tools/kit.py#L600-L767)).
...
This full texture/lightmap extraction pipeline is implemented in the corresponding extraction stage in the kit tooling ([`kit.py` L769-L1020](https://github.com/OldRepublicDevs/PyKotor/blob/a8daa4091b067e8424ae537793224e6b178ee9d8/Libraries/PyKotor/src/pykotor/tools/kit.py#L769-L1020)).
...
This door extraction workflow and JSON emission are implemented in the door handling pass of the kit extractor ([`kit.py` L1253-L1304](https://github.com/OldRepublicDevs/PyKotor/blob/a8daa4091b067e8424ae537793224e6b178ee9d8/Libraries/PyKotor/src/pykotor/tools/kit.py#L1253-L1304)).
...
These walkmesh extraction paths are implemented across the door/placeable/component extraction routines ([`kit.py` L1090-L1251](https://github.com/OldRepublicDevs/PyKotor/blob/a8daa4091b067e8424ae537793224e6b178ee9d8/Libraries/PyKotor/src/pykotor/tools/kit.py#L1090-L1251)).
...
This recentering algorithm is implemented in the dedicated BWM translation helper in the kit tool ([`kit.py` L1538-L1588](https://github.com/OldRepublicDevs/PyKotor/blob/a8daa4091b067e8424ae537793224e6b178ee9d8/Libraries/PyKotor/src/pykotor/tools/kit.py#L1538-L1588)).
...
This minimap generation and walkable-material filtering logic is implemented in the component image rendering code ([`kit.py` L1348-L1465](https://github.com/OldRepublicDevs/PyKotor/blob/a8daa4091b067e8424ae537793224e6b178ee9d8/Libraries/PyKotor/src/pykotor/tools/kit.py#L1348-L1465)).
...
This hook extraction and edge-index mapping are implemented in the doorhook generation routine ([`kit.py` L1467-L1535](https://github.com/OldRepublicDevs/PyKotor/blob/a8daa4091b067e8424ae537793224e6b178ee9d8/Libraries/PyKotor/src/pykotor/tools/kit.py#L1467-L1535)).
...
```
  ...
  This in-memory data model is defined by Holocron Toolset's indoor-kit base classes ([`indoorkit_base.py`](https://github.com/OldRepublicDevs/HolocronToolset/src/toolset/data/indoorkit/indoorkit_base.py)).
...
This end-to-end load flow is implemented in the kit loader entry point and helper routines ([`indoorkit_loader.py` L23-L260](https://github.com/OldRepublicDevs/PyKotor/blob/a8daa4091b067e8424ae537793224e6b178ee9d8/Tools/HolocronToolset/src/toolset/data/indoorkit/indoorkit_loader.py#L23-L260)).
...
This generation pipeline is implemented in the indoor map builder's assembly and serialization flow ([`indoormap.py`](https://github.com/OldRepublicDevs/HolocronToolset/src/toolset/data/indoormap.py)).
...
The shared resource-priority and format assumptions are implemented in the kit priority helpers ([`kit.py` L74-L120](https://github.com/OldRepublicDevs/PyKotor/blob/a8daa4091b067e8424ae537793224e6b178ee9d8/Libraries/PyKotor/src/pykotor/tools/kit.py#L74-L120)).
...
The PyKotor DWK extraction behavior described above is implemented in the dedicated door walkmesh extraction path ([`kit.py` L1090-L1174](https://github.com/OldRepublicDevs/PyKotor/blob/a8daa4091b067e8424ae537793224e6b178ee9d8/Libraries/PyKotor/src/pykotor/tools/kit.py#L1090-L1174)).
...
The PyKotor PWK extraction behavior described above is implemented in the placeable walkmesh extraction path ([`kit.py` L1176-L1251](https://github.com/OldRepublicDevs/PyKotor/blob/a8daa4091b067e8424ae537793224e6b178ee9d8/Libraries/PyKotor/src/pykotor/tools/kit.py#L1176-L1251)).
...
The corresponding PyKotor room/component detection logic is implemented in the component identification path ([`kit.py` L545-L767](https://github.com/OldRepublicDevs/PyKotor/blob/a8daa4091b067e8424ae537793224e6b178ee9d8/Libraries/PyKotor/src/pykotor/tools/kit.py#L545-L767)).
...
PyKotor's door model-resolution helper is implemented in the door utility module ([`door.py` L25-L64](https://github.com/OldRepublicDevs/PyKotor/blob/a8daa4091b067e8424ae537793224e6b178ee9d8/Libraries/PyKotor/src/pykotor/tools/door.py#L25-L64)).
...
PyKotor's placeable model-resolution helper is implemented in the placeable utility module ([`placeable.py` L20-L50](https://github.com/OldRepublicDevs/PyKotor/blob/a8daa4091b067e8424ae537793224e6b178ee9d8/Libraries/PyKotor/src/pykotor/tools/placeable.py#L20-L50)).
...
This texture/lightmap reference scanning behavior is implemented in the model utility iterators ([`model.py` L99-L887](https://github.com/OldRepublicDevs/PyKotor/blob/a8daa4091b067e8424ae537793224e6b178ee9d8/Libraries/PyKotor/src/pykotor/tools/model.py#L99-L887)).
...
PyKotor's implementation of this resource-priority behavior is defined in its kit resource-priority helpers ([`kit.py` L74-L120](https://github.com/OldRepublicDevs/PyKotor/blob/a8daa4091b067e8424ae537793224e6b178ee9d8/Libraries/PyKotor/src/pykotor/tools/kit.py#L74-L120)).
...
PyKotor's corresponding minimap and doorhook logic is implemented in the relevant extraction helpers ([`kit.py` L1348-L1465](https://github.com/OldRepublicDevs/PyKotor/blob/a8daa4091b067e8424ae537793224e6b178ee9d8/Libraries/PyKotor/src/pykotor/tools/kit.py#L1348-L1465), [`kit.py` L1467-L1535](https://github.com/OldRepublicDevs/PyKotor/blob/a8daa4091b067e8424ae537793224e6b178ee9d8/Libraries/PyKotor/src/pykotor/tools/kit.py#L1467-L1535)).
...
This exact-match behavior is asserted in the binary/hash comparison block of the kit generation tests ([`test_kit_generation.py` L912-L970](https://github.com/OldRepublicDevs/PyKotor/blob/a8daa4091b067e8424ae537793224e6b178ee9d8/Tools/HolocronToolset/tests/data/test_kit_generation.py#L912-L970)).
...
This tolerance-based image comparison is implemented in the image assertion block of the same test module ([`test_kit_generation.py` L972-L1111](https://github.com/OldRepublicDevs/PyKotor/blob/a8daa4091b067e8424ae537793224e6b178ee9d8/Tools/HolocronToolset/tests/data/test_kit_generation.py#L972-L1111)).
...
This structure-only behavior is visible in the later hook/door assertions that check field presence but do not compare values ([`test_kit_generation.py` L1113-L1234](https://github.com/OldRepublicDevs/PyKotor/blob/a8daa4091b067e8424ae537793224e6b178ee9d8/Tools/HolocronToolset/tests/data/test_kit_generation.py#L1113-L1234)).
