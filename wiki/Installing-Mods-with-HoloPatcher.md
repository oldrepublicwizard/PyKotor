...
- **HoloPatcher on Deadly Stream:** [file page + comments](https://deadlystream.com/files/file/2243-holopatcher/) — useful for release history and common user questions (this wiki remains SSOT for patcher _behavior_; threads are _context_).
