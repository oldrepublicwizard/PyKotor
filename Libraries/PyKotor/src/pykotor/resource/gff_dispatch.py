...
from pykotor.resource.generics.fac import bytes_fac, construct_fac, dismantle_fac, read_fac, write_fac
from pykotor.resource.generics.git import bytes_git, construct_git, dismantle_git, read_git, write_git
from pykotor.resource.generics.gui import bytes_gui, construct_gui, dismantle_gui, read_gui, write_gui
...
_BASE_GFF_RESOURCE_PIPELINES: dict[ResourceType, GFFResourcePipeline] = {
    ResourceType.GFF: GFFResourcePipeline(read_gff, _write_raw_gff, _bytes_raw_gff, _construct_gff, _dismantle_gff),
    ResourceType.RES: GFFResourcePipeline(read_gff, _write_raw_gff, _bytes_raw_gff, _construct_gff, _dismantle_gff),
    ...
    ResourceType.FAC: GFFResourcePipeline(read_fac, _write_fac_with_optional_game, _bytes_fac_with_optional_game, construct_fac, dismantle_fac),
    ResourceType.GIT: GFFResourcePipeline(read_git, write_git, bytes_git, construct_git, dismantle_git),
    ResourceType.GUI: GFFResourcePipeline(read_gui, write_gui, bytes_gui, construct_gui, dismantle_gui),
