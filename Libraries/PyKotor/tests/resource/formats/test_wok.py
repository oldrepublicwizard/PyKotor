...
class TestBWM(TestCase):
    ...
    def required_io_validation(self, wok: BWM):
        assert wok.faces[1].v1.distance(Vector3(12.667, 23.8963, -1.2749)) < 1000000.0, (
            f"{wok.faces[1].v1.distance(Vector3(12.667, 23.8963, -1.2749))} is not less than 1000000.0"
        )
        assert wok.faces[1].v2.distance(Vector3(12.4444, 28.6584, -1.275)) < 1000000.0, (
            f"{wok.faces[1].v2.distance(Vector3(12.4444, 28.6584, -1.275))} is not less than 1000000.0"
        )
        ...
        assert 2 == face4_adj[1].edge, f"{face4_adj[1].edge} != 2"  # pyright: ignore[reportOptionalMemberAccess]
        ...
        assert 1 == face4_adj[2].edge, f"{face4_adj[2].edge} != 1"  # pyright: ignore[reportOptionalMemberAccess]
