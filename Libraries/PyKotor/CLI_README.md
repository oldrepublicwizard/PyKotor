...
```bash
git clone https://github.com/oldrepublicwizard/PyKotor
cd PyKotor
python -m venv .venv
...
Contributions welcome! [See here for contributing guidelines.](https://github.com/oldrepublicwizard/PyKotor/edit/master/Libraries/PyKotor/docs/README.md)
